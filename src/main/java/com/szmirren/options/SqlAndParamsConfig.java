...
public class SqlAndParamsConfig {
	 ...
	 * @param tableItem
	 */
	public SqlAndParamsConfig(ObservableList<TableAttributeKeyValue> item) {
		super();
	 ...
	 * @param tableItem
	 */
	public SqlAndParamsConfig(ObservableList<TableAttributeKeyValue> item, String templateName, boolean overrideFile) {
		super();
		if (item != null && !item.isEmpty()) {
			tableItem.addAll(item);
		}
