...
public class AbstractSqlConfig {
	 ...
	 * @param tableItem
	 */
	public AbstractSqlConfig(ObservableList<TableAttributeKeyValue> item) {
		super();
	 ...
	 * @param tableItem
	 */
	public AbstractSqlConfig(ObservableList<TableAttributeKeyValue> item, String templateName, boolean overrideFile) {
		super();
		if (item != null && !item.isEmpty()) {
			tableItem.addAll(item);
		}
