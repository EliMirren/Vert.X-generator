...
public class JavaType {
	...
	public static boolean isInteger(String str) {
		if (str.equalsIgnoreCase("NUMBER") || str.equalsIgnoreCase("Int UNSIGNED") || str.equalsIgnoreCase("TINYINT UNSIGNED")
				|| str.equalsIgnoreCase("INTEGER") || str.equalsIgnoreCase("INT") || str.equalsIgnoreCase("TINYINT")
				|| str.equalsIgnoreCase("SMALLINT") || str.equalsIgnoreCase("BIT")) {
			return true;
		} else {
			return false;
		}
