...
public class ConverterUtil {
	 ...
	 *          实体类名
	 */
	public static void SqlConfigToContent(SqlConfig sc, SQLContent content, String className) {
		if (sc.getTableItem() != null) {
			String loCase = StrUtil.fristToLoCase(className);
			Map<String, Object> map = new HashMap<>();
			for (TableAttributeKeyValue c : sc.getTableItem()) {
	 ...
	 *          实体类名
	 */
	public static void routerConfigToContent(RouterConfig sc, RouterContent content, String className) {
		if (sc.getTableItem() != null) {
			String loCase = StrUtil.fristToLoCase(className);
			Map<String, Object> map = new HashMap<>();
			for (TableAttributeKeyValue c : sc.getTableItem()) {
	...
	/**
	 * 将AbstractSqlConfig转换为content
	 * 
	 * @param sc
	 *          AbstractSqlConfig配置信息
	 * @param content
	 *          上下文
	 * @param className
	 *          实体类名
	 */
	public static void abstractSqlConfigToContent(AbstractSqlConfig sc, AbstractSqlContent content, String className) {
		if (sc.getTableItem() != null) {
			String loCase = StrUtil.fristToLoCase(className);
			Map<String, Object> map = new HashMap<>();
			for (TableAttributeKeyValue c : sc.getTableItem()) {
	 ...
	 *          实体类名
	 */
	public static void sqlAndParamsConfigToContent(SqlAndParamsConfig sc, SqlAndParamsContent content, String className) {
		if (sc.getTableItem() != null) {
			String loCase = StrUtil.fristToLoCase(className);
			Map<String, Object> map = new HashMap<>();
			for (TableAttributeKeyValue c : sc.getTableItem()) {
